...
#
# Generated by export_simulation on Tue May 10 13:35:49 +0900 2016
#
################################################################################
...
switch to the './MemN2N_TOP.sh' script.

./MemN2N_TOP.sh -reset_run
...
./MemN2N_TOP.sh -noclean_files

For more information on the script, please type './MemN2N_TOP.sh -help'.
