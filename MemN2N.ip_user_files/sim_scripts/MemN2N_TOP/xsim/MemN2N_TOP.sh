...
reset_run()
{
  files_to_remove=(xelab.pb xsim.jou xvhdl.log xvlog.log compile.log elaborate.log simulate.log xelab.log xsim.log run.log xvhdl.pb xvlog.pb MemN2N_TOP.wdb xsim.dir)
...
elaborate()
{
  xelab --relax --debug typical --mt auto -wto 8a07141593a8483c86dc0df651455e37 -m64 -L xbip_utils_v3_0_5 -L axi_utils_v2_0_1 -L xbip_pipe_v3_0_1 -L xbip_dsp48_wrapper_v3_0_4 -L xbip_dsp48_addsub_v3_0_1 -L xbip_bram18k_v3_0_1 -L mult_gen_v12_0_10 -L floating_point_v7_0_11 -L xbip_dsp48_mult_v3_0_1 -L xbip_dsp48_multadd_v3_0_1 -L div_gen_v5_1_9 -L fifo_generator_v13_0_1 -L xil_defaultlib -L lib_cdc_v1_0_2 -L proc_sys_reset_v5_0_8 -L unisims_ver -L unimacro_ver -L secureip --snapshot MemN2N_TOP xil_defaultlib.MemN2N_TOP xil_defaultlib.glbl -log elaborate.log
}

# RUN_STEP: <simulate>
simulate()
{
  xsim MemN2N_TOP -key {Behavioral:tb_attention_memory:Functional:MemN2N_TOP} -tclbatch cmd.tcl -log simulate.log
}
# Script usage
usage()
{
